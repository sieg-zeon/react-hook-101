...
const EventForm = () => {
    ...
    const deleteAllOperationLogs = e => {
        e.preventDefault()
        const result = window.confirm('全ての操作ログを本当に削除してもを本当に削除しても良いですか？')
        if (result) {
            dispatch({
        ...
        <>
            ...
            <form>
                <div className="form-group">
                    ...
                    <input className="form-control" id="formEventTitle" value={title} onChange={e => setTilte(e.target.value)} />
                </div>
                <div className="form-group">
